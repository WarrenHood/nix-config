...
, ...
  ...
  flake.modules.nixos.niri =
    ...
    , ...
      ...
      # Actually, niri-unstable is kinda broken because libdisplay-info 0.2 was removed in the latest unstable nixpkgs
      # I'll maybe switch back to the sodiboo niri flake package once https://github.com/sodiboo/niri-flake/pull/1853 is merged in
